...
use Src\Package\Helpers\{UrlControls, URL};
/**
...
class ControllerLoader
{
    ...
    public static function getNamespacePrefix() : string 
    {
        ...
        // clean up prefix
        if (is_string($namespacePrefix) && strlen($namespacePrefix) > 1)  $returnValue = strtoupper(preg_replace('/[^a-z0-9A-Z\_]/', '', $namespacePrefix)) . '\\';
