...
$config->configurationSocket([
	'bootstrap'  => $socket->setClass(Src\Package\BootloaderConfiguration::class)->setMethod('loadBootstrap'),
	'finder'	 => $socket->setClass(Src\Package\BootloaderConfiguration::class)->setMethod('loadFinder'),
]);
...
$config->bootstrap ([
	...
	*/
	'assist_token' => '36f210738921e01ce8dda1789fbe61f085bbd61d',
	...
	*/
	'secret_key' => '709fc0bb8ec3413aaa4f0bab6001e5f17a4da629',
	...
	*/
	'secret_key_salt' => 'a6e64ba6b465f9cad59618730092badda41667fb',
