...
### Static
Contains Requests.css and Requests.js files and it's only avaliable for Requests views. This directory allows us define custom styles and scripts for our views that can also be extended by other controllers at run time.
