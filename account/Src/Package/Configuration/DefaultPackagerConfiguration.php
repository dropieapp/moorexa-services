<?php
namespace Src\Package\Configuration;
...
use Src\Package\Helpers\RouterControls;
/**
    ...
    public function defaultPackagerDependencies() : closure
    {
        return function(){
            ...
            $this->source(BootloaderConfiguration::class)->register([
                \Src\Package\BootloaderPrivates::class => 'for private methods on BootloaderConfiguration. it contains files like readEnvironmentVariables, which is important for reading environment variables.',
                \Symfony\Component\Yaml\Yaml::class => 'for reading YAML configuration environment file.',
                \Lightroom\Adapter\Configuration\Interfaces\EnvironmentInterface::class => 'for setting and reading environment variables.',
                \Src\Package\DirectoryAutoloader::class => 'for autoloading classes withing a directory.',
                ...
                \Src\Package\AutoloaderCachingSystem::class => 'for caching autoloaded files and classes to improve performance throughout our application.',
