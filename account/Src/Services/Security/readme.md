...
### Static
Contains Security.css and Security.js files and it's only avaliable for Security views. This directory allows us define custom styles and scripts for our views that can also be extended by other controllers at run time.
